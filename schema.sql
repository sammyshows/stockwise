...
CREATE TABLE transactions (id INT GENERATED ALWAYS AS IDENTITY, PRIMARY KEY(id), holding_id INT, type TEXT, quantity NUMERIC(10,3), initial_price NUMERIC(10,3), date DATE NOT NULL DEFAULT CURRENT_DATE, exchange_rate NUMERIC(10,3), CONSTRAINT fk_holding FOREIGN KEY(holding_id) REFERENCES holdings(id));
