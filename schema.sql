...
INSERT INTO holdings (portfolio_id, asset_id, share_count, initial_value, transaction_count) VALUES ((SELECT id FROM portfolios WHERE name='AUS EQUITIES'), (SELECT id FROM assets WHERE symbol='AAPL'), 4.3289, 625.2717588, 2);
...
INSERT INTO holdings (portfolio_id, asset_id, share_count, initial_value, transaction_count) VALUES ((SELECT id FROM portfolios WHERE name='U.S. EQUITIES'), (SELECT id FROM assets WHERE symbol='AAPL'), 13.7562, 2580.733590, 2);
...
INSERT INTO holdings (portfolio_id, asset_id, share_count, initial_value, transaction_count) VALUES ((SELECT id FROM portfolios WHERE name='Commodities'), (SELECT id FROM assets WHERE symbol='TSLA'), 2.78, 2510.0620, 1);
...
INSERT INTO transactions (holding_id, type, quantity, initial_price, exchange_rate, timestamp) VALUES ((SELECT id FROM holdings WHERE initial_value=625.2717588), 0, 50.1289, 142.692, 1.344, '2022-04-29T10:02:00.000Z');
INSERT INTO transactions (holding_id, type, quantity, initial_price, exchange_rate, timestamp) VALUES ((SELECT id FROM holdings WHERE initial_value=625.2717588), 0, 1.2, 149.0023, 1.293, '2022-04-29T10:02:01.000Z');
INSERT INTO transactions (holding_id, type, quantity, initial_price, exchange_rate, timestamp) VALUES ((SELECT id FROM holdings WHERE initial_value=625.2717588), 1, 13.68875, 153.27, 1.29, '2022-04-29T10:02:32.000Z');
...
INSERT INTO transactions (holding_id, type, quantity, initial_price, exchange_rate, timestamp) VALUES ((SELECT id FROM holdings WHERE initial_value=2580.733590), 0, 12.6562, 189.90, 1.344, '2022-04-29T10:02:00.000Z');
INSERT INTO transactions (holding_id, type, quantity, initial_price, exchange_rate, timestamp) VALUES ((SELECT id FROM holdings WHERE initial_value=2580.733590), 0, 1.1, 161.2011, 1.344, '2022-04-29T10:02:00.000Z');
...
INSERT INTO studies (user_id, asset_id, name, symbol, type, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='AAPL'), 'Apple Inc', 'AAPL', 0, 7, 8, 6, 8, 4, 1.345, 4.5661, NULL);
INSERT INTO studies (user_id, asset_id, name, symbol, type, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='TSLA'), 'Tesla', 'TSLA', 0, 4, 5, 3, 8, 6, 4.49, NULL, NULL);
INSERT INTO studies (user_id, asset_id, name, symbol, type, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='MSFT'), 'Microsoft Inc', 'MSFT', 0, 7, 8, 6, 8, 4, NULL, NULL, NULL);
INSERT INTO studies (user_id, asset_id, name, symbol, type, notes, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='TSLA'), 'Tesla', 'TSLA', 0, 'This study of Tesla was done following the leak that their car motors are powered by Hamsters in a wheel. Given the severity of this issue, I took the chance to re-evaluate my position as a Tesla shareholder.', 4, 5, 3, 8, 6, 4.49, 2.34, 7);
INSERT INTO studies (user_id, asset_id, name, symbol, type, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='MSFT'), 'Microsoft Inc', 'MSFT', 0, 4, 5, 3, 9, 3, 5.98, 2.43, 4);
INSERT INTO studies (user_id, asset_id, name, symbol, type, question_one, question_two, question_three, question_four, question_five, question_six, question_seven, question_eight) VALUES ((SELECT id FROM users WHERE email='sammymac.eng@gmail.com'), (SELECT id FROM assets WHERE symbol='NNOX'), 'Nano X Technology', 'NNOX', 4, 5, 3, 4, 9, 3, 0.9, 3.3, 5);
