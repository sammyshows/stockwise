<template>
  <div class="flex flex-col grow min-h-min px-3">
    <div class="h-1/2 flex items-end pb-8">
      <h2 class="text-2xl font-medium text-bright-cyan">HOW FAVOURABLE ARE THE LONG-TERM PROSPECTS OF THE BUSINESS?</h2>
    </div>
    <div class="h-1/2">
      ...
      <RadioGroup v-model="selectedNumber" @click="$emit('updateValue' ,'question_three', this.selectedNumber)">
