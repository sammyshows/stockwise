<template>
  <div class="relative w-full h-full flex flex-col overflow-scroll" :class="platform === 'ios' ? 'pt-14 pb-6' : 'pt-10 pb-5'">
    <div>
    ...
    <div v-if="!resetComplete" class="relative">
      <Transition name="send-email">
        <div v-if="!showResetForm" class="absolute mt-10 pb-20 px-10">
          <p class="mt-4 text-xs text-center text-gray-200">To reset your password, please enter your email so we can send you a password reset code:</p>
          <div class="mt-2.5">
      ...
      <Transition name="reset">
        <div v-if="showResetForm" class="absolute mt-10 pb-20 px-10">
          <p class="mt-4 text-xs text-center text-gray-200">An email has been sent to <span class="text-bright-cyan">{{ email }}</span>.</p>
          <p class="mt-2.5 text-xs text-center text-gray-200">Enter the secret code below and enter your new password:</p>
          ...
          <div class="pt-2.5 px-2.5 rounded-xl text-xs text-gray-200">
