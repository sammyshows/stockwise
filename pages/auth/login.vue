  ...
  <div class="w-full h-full flex flex-col justify-between px-10 overflow-scroll" :class="platform === 'ios' ? 'pt-14 pb-6' : 'pt-10 pb-5'">
    ...
    <div>
      ...
      <div class="mt-2.5">
        ...
        <input @keyup="invalid.email = false" v-model="email" autocomplete="off" placeholder="Email" type="text" style="touch-action: manipulation" class="placeholder:text-gray-500 w-full h-12 mt-1.5 text-sm rounded-xl bg-gray-900/20 border border-gray-400/40 focus:ring-0 focus:border-white">
      </div>
      <div class="mt-2.5">
        <p class="text-tiny leading-normal" :class="[ invalid.password ? 'text-red-600': 'hidden' ]">&#10033;&nbsp;&nbsp;Please add a valid password</p>
        <input @keyup="invalid.password = false" v-model="password" autocomplete="off" placeholder="Password" style="touch-action: manipulation" type="password" class="placeholder:text-gray-500 w-full h-12 mt-1.5 text-sm rounded-xl bg-gray-900/20 border border-gray-400/40 focus:ring-0 focus:border-white">
      </div>
