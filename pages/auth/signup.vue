  ...
  <div class="w-full h-full flex flex-col justify-between pt-10 pb-5 px-10 overflow-scroll">
    ...
    <div>
      ...
      <div class="mt-2.5">
        ...
        <input @keydown="invalid.password = false; validatePassword()" v-model="password" autocomplete="on" placeholder="Password" type="text" class="placeholder:text-gray-500 w-full h-12 mt-1.5 text-sm rounded-xl bg-gray-900/20 border border-gray-400/40 focus:ring-0 focus:border-white">
      </div>
