        ...
        <div class="h-0 flex flex-col grow overflow-scroll gap-y-4 text-xs">
          <TransitionGroup tag="div" name="form">
            <div :key="1" class="mb-2">
              ...
              <select v-model="transaction.type" id="type" class="w-full mt-1.5 py-1.5 text-xs rounded-md bg-gray-600/20 border border-gray-400/40 focus:ring-0 focus:border-white">
            ...
            <div :key="2" class="mb-2">
              ...
              <input @click="invalid.quantity = false" v-model="transaction.quantity" id="quantity" type="number" class="w-full mt-1.5 py-1.5 text-xs rounded-md bg-gray-600/20 border border-gray-400/40 focus:ring-0 focus:border-white">
            </div>
            <div :key="3" class="mb-2">
              ...
              <input @click="invalid.initialPrice = false" v-model="transaction.initialPrice" id="initialPrice" type="number" class="w-full mt-1.5 py-1.5 text-xs rounded-md bg-gray-600/20 border border-gray-400/40 focus:ring-0 focus:border-white">
            </div>
            <div :key="4" v-if="assetType === 0" class="mb-2">
              ...
              <input @click="invalid.exchangeRate = false" v-model="transaction.exchangeRate" id="exchangeRate" type="number" class="w-full mt-1.5 py-1.5 text-xs rounded-md bg-gray-600/20 border border-gray-400/40 focus:ring-0 focus:border-white">
            </div>
